...
<%@page import="com.DigiShop.dao.AdminDao"%>
			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body px-3">
						...
						<h3 class="text-center">اضافه کردن ادمین جدید</h3>
						...
						<form action="AdminServlet?operation=save" method="post">
							...
							<div class="d-grid gap-2 col-6 mx-auto py-3">
								<button type="submit" class="btn btn-primary me-3">ثبت نام</button>
							</div>
						</form>
					</div>
					...
					<div class="card-body px-3">
						<table class="table table-hover">
							...
							<tr class="text-center">
								...
								<td><%=a.getEmail() %></td>
								<td><%=a.getPhone() %></td>
								<td><a href="AdminServlet?operation=delete&id=<%=a.getId()%>" role="button" class="btn btn-danger">حذف</a></td>
							</tr>
							<%
							}
							%>
