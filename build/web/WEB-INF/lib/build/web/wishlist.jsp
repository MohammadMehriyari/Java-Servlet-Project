...
<%@page import="com.DigiShop.entities.Wishlist"%>
...
<div class="container px-3 py-3">
	...
	<div class="container mt-5 mb-5 text-center">
		<img src="Images/wishlist.png" style="max-width: 200px;"
			class="img-fluid">
		<h4 class="mt-3">خالی است</h4>
		هیچ کالایی را برای علاقه مندی خود اضافه نکرده اید
	</div>
	<%
	} else {
	%>
	<h4>
		علاقه مندی های  من (<%=wlist.size()%>)
	</h4>
	<hr>
	<div class="container">
		<table class="table table-hover">
			...
			<tr class="text-center">
				...
				<td><a
					...
					class="btn btn-secondary" role="button">حذف</a></td>
			</tr>
			<%
			}
			%>
