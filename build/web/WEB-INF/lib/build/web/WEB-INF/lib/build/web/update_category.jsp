...
<head>
<meta charset="UTF-8">
<title>آپدیت دسته بندی کالا ها</title>
				...
				<div class="card w-75">
					...
					<form action="AddOperationServlet?cid=<%=cid%>" method="post"
						...
						<div class="card-body">
							...
							<div class="mb-3">
								<label class="form-label"><b>عکس دسته بندی</b></label><input class="form-control" type="file" name="category_img">
							</div>
							<div class="mb-3">
								<label class="form-label"><b>عکس:&nbsp;</b></label><%=category.getCategoryImage()%>&emsp;<img
